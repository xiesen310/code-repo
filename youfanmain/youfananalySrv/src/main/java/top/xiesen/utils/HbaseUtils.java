...
public class HbaseUtils {
    ...
    static {
        ...
        conf.set("hbase.rootdir", "hdfs://192.168.231.150:9000/hbase");
        //使用eclipse时必须添加这个，否则无法定位
        conf.set("hbase.zookeeper.quorum", "192.168.231.150");
    ...
    /**
     * 插入数据 create 'userflaginfo', {NAME => 'baseinfo', VERSIONS => 1}
