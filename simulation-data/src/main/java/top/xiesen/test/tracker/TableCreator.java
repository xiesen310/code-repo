        ...
        for (String className : args) {
            ...
            for (Field field : cl.getDeclaredFields()) {
                ...
                if (anns[0] instanceof SQLInteger) {
                    ...
                    columnDef.append(columnName + " INT" + getConstraints(sInt.constraints()));
                }
                if (anns[0] instanceof SQLString) {
                    ...
                    columnDef.append(columnName + " VARCHAR(" + sString.value() + ")" + getConstraints(sString.constraints()));
                }
