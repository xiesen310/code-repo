 ...
 * @className top.xiesen.security.core.validate.code.ValidateCodeFilter
 * @Author 谢森
...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        String[] configUrl = StringUtils.splitByWholeSeparatorPreserveAllTokens(
                securityProperties.getCode().getImage().getUrl(), ",");
        for (String config : configUrl) {
            urls.add(config);
        }
